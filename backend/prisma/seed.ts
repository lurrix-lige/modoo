...
async function main() {
  ...
  const stories = [
    {
      title: '晚安小森林',
      titleKey: 'story.starNightForest.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/1.mp3',
      duration: 32,
      category: 'dream',
      description: '关于森林的美丽故事',
      descriptionKey: 'story.starNightForest.desc',
      isPremium: false,
    },
    {
      title: '勇气的冒险',
      ...
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/2.mp3',
      duration: 30,
      category: 'brave',
      description: '勇气的冒险故事',
    ...
    {
      title: '小枕头的魔法',
      titleKey: 'story.pillowMagic.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/3.mp3',
      duration: 25,
      category: 'brave',
      description: '小枕头克服恐惧的故事',
      descriptionKey: 'story.pillowMagic.desc',
      isPremium: false,
    },
    {
      title: '月亮，生日快乐',
      titleKey: 'story.moonBirthday.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/4.mp3',
      duration: 28,
      category: 'dream',
      description: '关于月亮生日的故事',
      descriptionKey: 'story.moonBirthday.desc',
      isPremium: false,
    },
    {
      title: '晚安大猩猩',
      titleKey: 'story.goodNightGorilla.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/5.mp3',
      duration: 28,
      category: 'dream',
      description: '一个勇敢的大猩猩的故事',
      descriptionKey: 'story.goodNightGorilla.desc',
      isPremium: true,
    },
    {
      title: '逃家小兔',
      titleKey: 'story.runawayRabbit.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/6.mp3',
      duration: 33,
      category: 'dream',
      description: '逃家小兔的故事',
      descriptionKey: 'story.runawayRabbit.desc',
      isPremium: true,
    },
    {
      title: '云朵小绵羊',
      titleKey: 'story.cloudSheep.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/7.mp3',
      duration: 27,
      category: 'dream',
      description: '云朵小绵羊的故事',
      descriptionKey: 'story.cloudSheep.desc',
      isPremium: true,
    },
    {
      title: '月亮的悄悄话',
      titleKey: 'story.moonWhisper.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/8.mp3',
      duration: 29,
      category: 'dream',
      description: '一个月亮的悄悄话的故事',
      descriptionKey: 'story.moonWhisper.desc',
      isPremium: true,
    },
    {
      title: '猜猜我有多爱你',
      titleKey: 'story.loveYou.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/9.mp3',
      duration: 31,
      category: 'dream',
      description: '一个猜猜我有多爱你的故事',
      descriptionKey: 'story.loveYou.desc',
      isPremium: true,
    },
    {
      title: '小星星陪我',
      titleKey: 'story.starCompanion.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/10.mp3',
      duration: 24,
      category: 'dream',
      description: '一个小星星陪我的故事',
      descriptionKey: 'story.starCompanion.desc',
      isPremium: true,
    },
    {
      title: '小兔子很怕黑',
      titleKey: 'story.rabbitAfraidDark.title',
      coverUrl: 'http://47.94.165.219:3000/api/v1/images/logo.png',
      audioUrl: 'http://47.94.165.219:3000/api/v1/audio/stories/11.mp3',
      duration: 59,
      category: 'dream',
      description: '一个小兔子很怕黑的故事',
      descriptionKey: 'story.rabbitAfraidDark.desc',
      isPremium: true,
    },
  ];
  ...
  lessons.push(
    { courseId: createdCourses[0].id, order: 1, title: '认识我们的眼睛', titleKey: 'course.level1.lesson1.title', description: '了解眼睛是怎么看到东西的', descriptionKey: 'course.level1.lesson1.desc', duration: 180, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-1.mp3', isCompleted: true },
    { courseId: createdCourses[0].id, order: 2, title: '白天和黑夜', titleKey: 'course.level1.lesson2.title', description: '了解为什么会有白天和黑夜', descriptionKey: 'course.level1.lesson2.desc', duration: 240, type: 'video', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-2.mp4', isCompleted: true },
    { courseId: createdCourses[0].id, order: 3, title: '黑暗里有什么', titleKey: 'course.level1.lesson3.title', description: '探索黑暗中的事物', descriptionKey: 'course.level1.lesson3.desc', duration: 300, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-3.mp3', isCompleted: true },
    { courseId: createdCourses[0].id, order: 4, title: '小夜灯的魔法', titleKey: 'course.level1.lesson4.title', description: '学习使用小夜灯', descriptionKey: 'course.level1.lesson4.desc', duration: 200, type: 'interactive', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-4.json', isCompleted: false },
    { courseId: createdCourses[0].id, order: 5, title: '安全的小角落', titleKey: 'course.level1.lesson5.title', description: '创建自己的安全角落', descriptionKey: 'course.level1.lesson5.desc', duration: 260, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-5.mp3', isCompleted: false },
    { courseId: createdCourses[0].id, order: 6, title: '黑暗探索小游戏', titleKey: 'course.level1.lesson6.title', description: '在黑暗中寻找宝藏', descriptionKey: 'course.level1.lesson6.desc', duration: 300, type: 'interactive', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-6.json', isCompleted: false },
    { courseId: createdCourses[0].id, order: 7, title: '睡前放松练习', titleKey: 'course.level1.lesson7.title', description: '学习睡前放松的小方法', descriptionKey: 'course.level1.lesson7.desc', duration: 240, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-7.mp3', isCompleted: false },
    { courseId: createdCourses[0].id, order: 8, title: '第一级毕业啦', titleKey: 'course.level1.lesson8.title', description: '恭喜完成第一级课程', descriptionKey: 'course.level1.lesson8.desc', duration: 180, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-8.mp3', isCompleted: false },
    { courseId: createdCourses[0].id, order: 9, title: '小测试', titleKey: 'course.level1.lesson9.title', description: '测试你学到了什么', descriptionKey: 'course.level1.lesson9.desc', duration: 120, type: 'interactive', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-9.json', isCompleted: false },
    { courseId: createdCourses[0].id, order: 10, title: '勇敢的小勋章', titleKey: 'course.level1.lesson10.title', description: '获得勇敢小勋章', descriptionKey: 'course.level1.lesson10.desc', duration: 60, type: 'video', contentUrl: 'https://47.94.165.219/api/v1/lessons/1-10.mp3', isCompleted: false }
  );

  lessons.push(
    { courseId: createdCourses[1].id, order: 1, title: '勇敢的小榜样', titleKey: 'course.level2.lesson1.title', description: '认识勇敢的小榜样', descriptionKey: 'course.level2.lesson1.desc', duration: 200, type: 'video', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-1.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 2, title: '我害怕什么', titleKey: 'course.level2.lesson2.title', description: '说出你害怕的东西', descriptionKey: 'course.level2.lesson2.desc', duration: 240, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-2.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 3, title: '爸爸妈妈在身边', titleKey: 'course.level2.lesson3.title', description: '知道有人在保护你', descriptionKey: 'course.level2.lesson3.desc', duration: 180, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-3.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 4, title: '勇敢小口号', titleKey: 'course.level2.lesson4.title', description: '学习勇敢小口号', descriptionKey: 'course.level2.lesson4.desc', duration: 120, type: 'interactive', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-4.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 5, title: '黑暗挑战', titleKey: 'course.level2.lesson5.title', description: '第一次黑暗小挑战', descriptionKey: 'course.level2.lesson5.desc', duration: 300, type: 'interactive', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-5.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 6, title: '勇敢小日记', titleKey: 'course.level2.lesson6.title', description: '记录你的勇敢时刻', descriptionKey: 'course.level2.lesson6.desc', duration: 200, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-6.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 7, title: '小帮手', titleKey: 'course.level2.lesson7.title', description: '帮助其他害怕的小朋友', descriptionKey: 'course.level2.lesson7.desc', duration: 260, type: 'audio', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-7.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 8, title: '更大的挑战', titleKey: 'course.level2.lesson8.title', description: '黑暗中更久的停留', descriptionKey: 'course.level2.lesson8.desc', duration: 300, type: 'interactive', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-8.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 9, title: '第二级毕业', titleKey: 'course.level2.lesson9.title', description: '恭喜完成第二级', descriptionKey: 'course.level2.lesson9.desc', duration: 180, type: 'video', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-9.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 10, title: '勇敢勋章升级', titleKey: 'course.level2.lesson10.title', description: '获得更高级的勇敢勋章', descriptionKey: 'course.level2.lesson10.desc', duration: 60, type: 'video', contentUrl: 'https://47.94.165.219/api/v1/lessons/2-10.mp3', isCompleted: false }
  );
