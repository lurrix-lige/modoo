...
async function main() {
  ...
  const stories = [
    ...
    },
    {
      ...
      coverUrl: 'http://192.168.124.13:3000/api/v1/images/logo.png',
      audioUrl: 'http://192.168.124.13:3000/api/v1/audio/raining-S00-00-02.m4a',
      duration: 240,
      category: 'dream',
    ...
    },
    {
      ...
      coverUrl: 'http://192.168.124.13:3000/api/v1/images/logo.png',
      audioUrl: 'http://192.168.124.13:3000/api/v1/audio/raining-S00-00-03.m4a',
      duration: 200,
      category: 'brave',
      description: '勇气的冒险故事',
    ...
    },
    {
      ...
      coverUrl: 'http://192.168.124.13:3000/api/v1/images/logo.png',
      audioUrl: 'http://192.168.124.13:3000/api/v1/audio/raining-S00-00-04.m4a',
      duration: 220,
      category: 'dream',
  ...
  lessons.push(
    { courseId: createdCourses[0].id, order: 1, title: '认识我们的眼睛', titleKey: 'course.level1.lesson1.title', description: '了解眼睛是怎么看到东西的', descriptionKey: 'course.level1.lesson1.desc', duration: 180, type: 'audio', contentUrl: 'https://example.com/lessons/1-1.mp3', isCompleted: true },
    { courseId: createdCourses[0].id, order: 2, title: '白天和黑夜', titleKey: 'course.level1.lesson2.title', description: '了解为什么会有白天和黑夜', descriptionKey: 'course.level1.lesson2.desc', duration: 240, type: 'video', contentUrl: 'https://example.com/lessons/1-2.mp4', isCompleted: true },
    { courseId: createdCourses[0].id, order: 3, title: '黑暗里有什么', titleKey: 'course.level1.lesson3.title', description: '探索黑暗中的事物', descriptionKey: 'course.level1.lesson3.desc', duration: 300, type: 'audio', contentUrl: 'https://example.com/lessons/1-3.mp3', isCompleted: true },
    { courseId: createdCourses[0].id, order: 4, title: '小夜灯的魔法', titleKey: 'course.level1.lesson4.title', description: '学习使用小夜灯', descriptionKey: 'course.level1.lesson4.desc', duration: 200, type: 'interactive', contentUrl: 'https://example.com/lessons/1-4.json', isCompleted: false },
    { courseId: createdCourses[0].id, order: 5, title: '安全的小角落', titleKey: 'course.level1.lesson5.title', description: '创建自己的安全角落', descriptionKey: 'course.level1.lesson5.desc', duration: 260, type: 'audio', contentUrl: 'https://example.com/lessons/1-5.mp3', isCompleted: false },
    { courseId: createdCourses[0].id, order: 6, title: '黑暗探索小游戏', titleKey: 'course.level1.lesson6.title', description: '在黑暗中寻找宝藏', descriptionKey: 'course.level1.lesson6.desc', duration: 300, type: 'interactive', contentUrl: 'https://example.com/lessons/1-6.json', isCompleted: false },
    { courseId: createdCourses[0].id, order: 7, title: '睡前放松练习', titleKey: 'course.level1.lesson7.title', description: '学习睡前放松的小方法', descriptionKey: 'course.level1.lesson7.desc', duration: 240, type: 'audio', contentUrl: 'https://example.com/lessons/1-7.mp3', isCompleted: false },
    { courseId: createdCourses[0].id, order: 8, title: '第一级毕业啦', titleKey: 'course.level1.lesson8.title', description: '恭喜完成第一级课程', descriptionKey: 'course.level1.lesson8.desc', duration: 180, type: 'audio', contentUrl: 'https://example.com/lessons/1-8.mp3', isCompleted: false },
    { courseId: createdCourses[0].id, order: 9, title: '小测试', titleKey: 'course.level1.lesson9.title', description: '测试你学到了什么', descriptionKey: 'course.level1.lesson9.desc', duration: 120, type: 'interactive', contentUrl: 'https://example.com/lessons/1-9.json', isCompleted: false },
    { courseId: createdCourses[0].id, order: 10, title: '勇敢的小勋章', titleKey: 'course.level1.lesson10.title', description: '获得勇敢小勋章', descriptionKey: 'course.level1.lesson10.desc', duration: 60, type: 'video', contentUrl: 'https://example.com/lessons/1-10.mp4', isCompleted: false }
  );

  lessons.push(
    { courseId: createdCourses[1].id, order: 1, title: '勇敢的小榜样', titleKey: 'course.level2.lesson1.title', description: '认识勇敢的小榜样', descriptionKey: 'course.level2.lesson1.desc', duration: 200, type: 'video', contentUrl: 'https://example.com/lessons/2-1.mp4', isCompleted: false },
    { courseId: createdCourses[1].id, order: 2, title: '我害怕什么', titleKey: 'course.level2.lesson2.title', description: '说出你害怕的东西', descriptionKey: 'course.level2.lesson2.desc', duration: 240, type: 'audio', contentUrl: 'https://example.com/lessons/2-2.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 3, title: '爸爸妈妈在身边', titleKey: 'course.level2.lesson3.title', description: '知道有人在保护你', descriptionKey: 'course.level2.lesson3.desc', duration: 180, type: 'audio', contentUrl: 'https://example.com/lessons/2-3.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 4, title: '勇敢小口号', titleKey: 'course.level2.lesson4.title', description: '学习勇敢小口号', descriptionKey: 'course.level2.lesson4.desc', duration: 120, type: 'interactive', contentUrl: 'https://example.com/lessons/2-4.json', isCompleted: false },
    { courseId: createdCourses[1].id, order: 5, title: '黑暗挑战', titleKey: 'course.level2.lesson5.title', description: '第一次黑暗小挑战', descriptionKey: 'course.level2.lesson5.desc', duration: 300, type: 'interactive', contentUrl: 'https://example.com/lessons/2-5.json', isCompleted: false },
    { courseId: createdCourses[1].id, order: 6, title: '勇敢小日记', titleKey: 'course.level2.lesson6.title', description: '记录你的勇敢时刻', descriptionKey: 'course.level2.lesson6.desc', duration: 200, type: 'audio', contentUrl: 'https://example.com/lessons/2-6.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 7, title: '小帮手', titleKey: 'course.level2.lesson7.title', description: '帮助其他害怕的小朋友', descriptionKey: 'course.level2.lesson7.desc', duration: 260, type: 'audio', contentUrl: 'https://example.com/lessons/2-7.mp3', isCompleted: false },
    { courseId: createdCourses[1].id, order: 8, title: '更大的挑战', titleKey: 'course.level2.lesson8.title', description: '黑暗中更久的停留', descriptionKey: 'course.level2.lesson8.desc', duration: 300, type: 'interactive', contentUrl: 'https://example.com/lessons/2-8.json', isCompleted: false },
    { courseId: createdCourses[1].id, order: 9, title: '第二级毕业', titleKey: 'course.level2.lesson9.title', description: '恭喜完成第二级', descriptionKey: 'course.level2.lesson9.desc', duration: 180, type: 'video', contentUrl: 'https://example.com/lessons/2-9.mp4', isCompleted: false },
    { courseId: createdCourses[1].id, order: 10, title: '勇敢勋章升级', titleKey: 'course.level2.lesson10.title', description: '获得更高级的勇敢勋章', descriptionKey: 'course.level2.lesson10.desc', duration: 60, type: 'video', contentUrl: 'https://example.com/lessons/2-10.mp4', isCompleted: false }
  );
  ...
  for (let c = 2; c < createdCourses.length; c++) {
    for (let i = 1; i <= 10; i++) {
      lessons.push({
        ...
        contentUrl: `http://192.168.124.13:3000/api/v1/lessons/${c + 1}-${i}.mp3`,
        isCompleted: false
      });
    }
  }
  ...
  const experts = [
    {
      ...
      avatarUrl: 'http://192.168.124.13:3000/api/v1/images/logo.png',
